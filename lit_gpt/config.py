...
llama_2_multilingual = [
    dict(
        org="EricPeter",
        name="Llama-2-multilingual",
        block_size=4096,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=32,
    ...
    dict(
        org="meta-llama",
        name="Llama-2-7b-hf-zh",
        block_size=4096,
        vocab_size=40076,
        padded_vocab_size=40076,
        padding_multiple=64,
        n_layer=32,
        n_head=32,
        n_embd=4096,
    ...
    dict(
        org="meta-llama",
        name="Llama-2-7b-hf-ja",
        block_size=4096,
        vocab_size=45043,
        padded_vocab_size=45043,
        padding_multiple=64,
        n_layer=32,
        n_head=32,
        n_embd=4096,
...
configs.extend(llama_2_multilingual)
